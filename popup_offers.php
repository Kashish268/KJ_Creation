...
$q = "SELECT COUNT(*) AS total_rows FROM popup_image";
            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a class="active" href="popup_offers.php">Offers</a>
                        </li>
                    </ul>
                </div>
                <a href="add_popup_image.php" class="btn-download <?= ($row_count > 0) ? 'disabled' : ''; ?>" 
...
<form action="popup_offers.php" method="post" style="display: inline;">
    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
...
if(isset($_POST['delete_row'])){
    $id=$_POST['id'];
    $q="delete from popup_image where id=$id";
    if (mysqli_query($conn, $q)) {
        echo "<script>
            alert('Offer deleted successfully');
            window.location.href = 'popup_offers.php';
        </script>";
    } else {
        echo "<script>
