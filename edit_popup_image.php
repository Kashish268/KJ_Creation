...
$q = "SELECT * FROM popup_image WHERE id = $id"; // Query to fetch product details
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<script>alert('Image not found'); window.location.href = 'popup_offers.php';</script>";
    exit();
}
        ...
        <main>
            <div style="margin-bottom: 30px;">
                ...
                <p style="text-align: left; color: #c4c4c4; font-size: 1rem;">
                    <a href ="popup_offers.php" style="text-decoration: none; color: #c4c4c4;">Images</a> 
                    <span style="margin: 0 8px;">&gt;</span>
                    <span style="color: rgb(244, 107, 44);">Edit Image</span>
                </p>
            </div>
            <form id="productForm" method="post" enctype="multipart/form-data" action="update_popup_image.php">
