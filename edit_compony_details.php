...
$q = "SELECT * FROM compony_details WHERE id = $id"; // Query to fetch product details
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<script>alert('Image not found'); window.location.href = 'compony_details.php';</script>";
    exit();
}
        ...
        <main>
            <div style="margin-bottom: 30px;">
                ...
                <p style="text-align: left; color: #c4c4c4; font-size: 1rem;">
                    <a href="add_compony_details.php" style="text-decoration: none; color: #c4c4c4;">Images</a> 
                    <span style="margin: 0 8px;">&gt;</span>
                    <span style="color: rgb(244, 107, 44);">Edit Image</span>
                </p>
            </div>
            <form id="productForm" method="post" enctype="multipart/form-data" action="update_compony_details.php">
