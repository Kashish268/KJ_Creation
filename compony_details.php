...
$q="SELECT * FROM compony_details ORDER BY id DESC";
            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a class="active" href="compony_details.php">Compony Details</a>
                        </li>
                    </ul>
                </div>
                <a href="add_compony_details.php" class="btn-download">
...
<tr>
    ...
    <td>
    <form action="edit_compony_details.php" method="post" style="display: inline;">
...
<form action="compony_details.php" method="post" style="display: inline;">
    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
...
<?php
    ...
    $id=$_POST['id'];
    $q="delete from compony_details where id=$id";
