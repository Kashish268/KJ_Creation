...
$q = "SELECT * FROM offers WHERE id = $id"; // Query to fetch product details
    ...
    <section id="content">
        ...
        <main>
            <div style="margin-bottom: 30px;">
                <h2 style="text-align: left; color: rgb(244, 107, 44); font-size: 36px; font-weight: 600; margin-bottom: 10px;">Edit Offer</h2>
                <p style="text-align: left; color: #c4c4c4; font-size: 1rem;">
                    ...
                    <span style="color: rgb(244, 107, 44);">Edit Offer</span>
                </p>
            </div>
            <form id="productForm" method="post" enctype="multipart/form-data" action="update_offer.php">
                ...
                <input type="text" 
    id="price" 
    name="price" value="<?php echo $a['offer_percentage']; ?>">
...
<input type="file" id="productImage" name="productImage"  onchange="previewImage(this)">
    ...
    <script src="validation_o_edit.js"></script>
    <script>
