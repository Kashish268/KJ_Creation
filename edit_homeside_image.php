...
$q = "SELECT * FROM home_side_image WHERE id = $id"; // Query to fetch product details
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<script>alert('Image not found'); window.location.href = 'homepage.php';</script>";
    exit();
}
        ...
        <main>
            <div style="margin-bottom: 30px;">
                ...
                <p style="text-align: left; color: #c4c4c4; font-size: 1rem;">
                    <a href="homepage.php" style="text-decoration: none; color: #c4c4c4;">Images</a> 
                    <span style="margin: 0 8px;">&gt;</span>
                    <span style="color: rgb(244, 107, 44);">Edit Image</span>
                </p>
            </div>
            <form id="productForm" method="post" enctype="multipart/form-data" action="update_homeside_image.php">
            <label for="productName">Select Postion Of Image</label>
        <select id="productName" name="productName">
        <option value="Above" <?php echo ($a['image_position'] == 'Above') ? 'selected' : ''; ?>>Above</option>
    <option value="Below" <?php echo ($a['image_position'] == 'Below') ? 'selected' : ''; ?>>Below</option>
</select>
