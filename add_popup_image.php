...
if (isset($_POST['sub'])) {
    ...
    if (!in_array($file_extension, $allowed_extensions)) {
        ...
        if (move_uploaded_file($tem_img, $upload_dir . $img)) {
            $q = "INSERT INTO popup_image(title, image) VALUES ('$p_name',  '$img')";
            if (mysqli_query($conn, $q)) {
                echo "<script>alert('Add Offer Successfully!'); window.location.href='popup_offers.php';</script>";
            } else {
...
<body>
    ...
    <div style="margin-bottom: 30px;">
        ...
        <p style="text-align: left; color: #c4c4c4; font-size: 1rem;">
            <a href="popup_offers.php" style="text-decoration: none; color: #c4c4c4;">Offers</a> 
