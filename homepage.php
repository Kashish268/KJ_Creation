...
$q="SELECT * FROM home_side_image ORDER BY id DESC";
            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a class="active" href="homepage.php">Side Images</a>
                        </li>
                    </ul>
                </div>
                <a href="add_homeside_image.php" class="btn-download">
...
<?php
    ...
    $id=$_POST['id'];
    $q="delete from home_side_image where id=$id";
